...
def home(request):
    ...
    # print(type(b))
            ...
            for doc in b:
                ...
                doc_st='Store: '+  doc['store']
                doc_pr='Price: '+ doc['price']
                doc_des='Description: '+ doc['description']
                good_loc = 'Store_location: '+ doc['location']
                good_ltlng = geolocation(good_loc)
                Dis_2_store = 'Distance: 'Distance(User_Lat, good_ltlng)
